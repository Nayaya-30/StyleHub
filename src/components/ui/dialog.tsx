...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-border bg-card p-8 shadow-large duration-300 data-[state=open]:animate-scale-in data-[state=closed]:animate-fade-out sm:rounded-2xl",
        className
      )}
      {...props}
    >
